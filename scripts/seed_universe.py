...
async def seed_universe(
    ...
    if fetch_prices:
        ...
        logger.info("Fetching %d days of price history...", price_days)
        price_provider = get_price_provider()
        price_repo = PriceRepository()
        start_date = date.today() - timedelta(days=price_days)
...
def main():
    ...
    parser.add_argument("--price-days", type=int, default=365, help="Days of price history (default: 365)")
